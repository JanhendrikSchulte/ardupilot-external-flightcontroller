...
#define HAL_BOARD_NAME "EXTERNALFC"
...
#include <AP_HAL_EXTERNALFC/Semaphores.h>
#define HAL_Semaphore HALEXTERNALFC::Semaphore
#define HAL_BinarySemaphore HALEXTERNALFC::BinarySemaphore
#endif
