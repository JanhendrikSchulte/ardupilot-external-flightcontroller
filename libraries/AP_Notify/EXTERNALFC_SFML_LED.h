...
private:
    ...
    // LED layout control
    bool layout_size(EXTERNALFC::LedLayout layout, uint16_t &xsize, uint16_t &ysize);
    bool layout_pos(EXTERNALFC::LedLayout layout, uint8_t chan, uint8_t led, uint16_t &xpos, uint16_t &ypos);
};
