...
#define AP_PROXIMITY_AIRSIMSITL_ENABLED AP_PROXIMITY_BACKEND_DEFAULT_ENABLED && ((CONFIG_HAL_BOARD == HAL_BOARD_SITL)  || (CONFIG_HAL_BOARD == HAL_BOARD_EXTERNALFC))
#endif
...
#define AP_PROXIMITY_SITL_ENABLED AP_PROXIMITY_BACKEND_DEFAULT_ENABLED && ((CONFIG_HAL_BOARD == HAL_BOARD_SITL) || (CONFIG_HAL_BOARD == HAL_BOARD_EXTERNALFC))
#endif
