...
#else
#define AP_NETWORKING_ENABLED ((CONFIG_HAL_BOARD == HAL_BOARD_LINUX) || (CONFIG_HAL_BOARD == HAL_BOARD_SITL) || (CONFIG_HAL_BOARD == HAL_BOARD_EXTERNALFC))
#endif
#endif
...
#define AP_NETWORKING_BACKEND_SITL (AP_NETWORKING_BACKEND_DEFAULT_ENABLED && ((CONFIG_HAL_BOARD == HAL_BOARD_SITL) || (CONFIG_HAL_BOARD == HAL_BOARD_EXTERNALFC)))
#endif
