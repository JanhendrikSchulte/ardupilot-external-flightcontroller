...
constexpr const int32_t EXTERNALFC::TSYS01::_k[5];

int EXTERNALFC::TSYS01::rdwr(I2C::i2c_rdwr_ioctl_data *&data)
{
    if (data->nmsgs == 2) {
...
float EXTERNALFC::TSYS01::temperature_for_adc(uint32_t _adc) const
{
...
uint32_t EXTERNALFC::TSYS01::calculate_adc(float temperature) const
{
...
void EXTERNALFC::TSYS01::update(const class Aircraft &aircraft)
{
    switch (state) {
    case State::UNKNOWN:
        break;
...
float EXTERNALFC::TSYS01::get_sim_temperature() const
{
