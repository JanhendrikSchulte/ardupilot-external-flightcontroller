...
EXTERNALFC::Calibration::Calibration(const char *frame_str)
    : Aircraft(frame_str)
{
    mass = 1.5f;
}

void EXTERNALFC::Calibration::update(const struct sitl_input &input)
{
...
void EXTERNALFC::Calibration::_stop_control(const struct sitl_input &input,
                                      Vector3f& rot_accel)
{
...
void EXTERNALFC::Calibration::_attitude_control(const struct sitl_input &input,
                                          Vector3f& rot_accel)
{
...
void EXTERNALFC::Calibration::_attitude_set(float desired_roll, float desired_pitch, float desired_yaw,
                                      Vector3f& rot_accel)
{
    float dt = frame_time_us * 1.0e-6f;
...
void EXTERNALFC::Calibration::_angular_velocity_control(const struct sitl_input &in,
                                                  Vector3f& rot_accel)
{
 ...
 */
void EXTERNALFC::Calibration::_calibration_poses(Vector3f& rot_accel)
{
    const struct pose {
