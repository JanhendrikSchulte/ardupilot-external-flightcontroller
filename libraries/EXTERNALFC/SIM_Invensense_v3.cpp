...
void EXTERNALFC::InvensenseV3::update(const class Aircraft &aircraft)
{
...
void EXTERNALFC::InvensenseV3::assert_register_values()
{
...
int EXTERNALFC::InvensenseV3::rdwr(I2C::i2c_rdwr_ioctl_data *&data)
{
...
int EXTERNALFC::InvensenseV3::rdwr_fifo(I2C::i2c_rdwr_ioctl_data *&data)
{
    const uint8_t addr = data->msgs[0].buf[0];
...
void EXTERNALFC::InvensenseV3::add_fifo(const char *name, uint8_t reg, I2CRegisters::RegMode mode)
{
...
void EXTERNALFC::InvensenseV3::update_sample_count()
{
...
bool EXTERNALFC::InvensenseV3::write_to_fifo(uint8_t fifo, uint8_t *value, uint8_t valuelen)
{
...
void EXTERNALFC::InvensenseV3::add_block(const char *name, uint8_t addr, uint8_t len, I2CRegisters::RegMode mode)
{
...
void EXTERNALFC::InvensenseV3::set_block(uint8_t addr, uint8_t *value, uint8_t valuelen)
{
    if (blockname[addr] == nullptr) {
...
int EXTERNALFC::InvensenseV3::rdwr_block(I2C::i2c_rdwr_ioctl_data *&data)
{
    const uint8_t addr = data->msgs[0].buf[0];
