...
int EXTERNALFC::SMBusDevice::rdwr(I2C::i2c_rdwr_ioctl_data *&data)
{
...
void EXTERNALFC::SMBusDevice::add_block(const char *name, uint8_t reg, I2CRegisters::RegMode mode)
{
...
void EXTERNALFC::SMBusDevice::set_block(uint8_t block, uint8_t *value, uint8_t valuelen)
{
