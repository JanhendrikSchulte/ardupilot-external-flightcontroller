...
constexpr const uint8_t EXTERNALFC::TSYS03::serial[3];

int EXTERNALFC::TSYS03::rdwr_handle_read(I2C::i2c_rdwr_ioctl_data *&data)
{
...
int EXTERNALFC::TSYS03::rdwr_handle_write(I2C::i2c_rdwr_ioctl_data *&data)
{
...
int EXTERNALFC::TSYS03::rdwr(I2C::i2c_rdwr_ioctl_data *&data)
{
    if (data->nmsgs == 2) {
...
float EXTERNALFC::TSYS03::temperature_for_adc(const uint16_t _adc) const
{
...
uint16_t EXTERNALFC::TSYS03::calculate_adc(float temperature) const
{
...
void EXTERNALFC::TSYS03::update(const class Aircraft &aircraft)
{
    switch (state) {
    case State::UNKNOWN:
        break;
...
float EXTERNALFC::TSYS03::get_sim_temperature(const Aircraft &aircraft) const
{
