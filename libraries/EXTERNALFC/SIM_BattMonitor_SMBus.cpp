...
EXTERNALFC::SIM_BattMonitor_SMBus::SIM_BattMonitor_SMBus() :
    SMBusDevice()
{
    add_register("Temperature", SMBusBattDevReg::TEMP, EXTERNALFC::I2CRegisters::RegMode::RDONLY);
    add_register("Voltage", SMBusBattDevReg::VOLTAGE, EXTERNALFC::I2CRegisters::RegMode::RDONLY);
    add_register("Current", SMBusBattDevReg::CURRENT, EXTERNALFC::I2CRegisters::RegMode::RDONLY);
    add_register("Remaining Capacity", SMBusBattDevReg::REMAINING_CAPACITY, EXTERNALFC::I2CRegisters::RegMode::RDONLY);
    add_register("Full Charge Capacity", SMBusBattDevReg::FULL_CHARGE_CAPACITY, EXTERNALFC::I2CRegisters::RegMode::RDONLY);
    add_register("Cycle_Count", SMBusBattDevReg::CYCLE_COUNT, EXTERNALFC::I2CRegisters::RegMode::RDONLY);
    add_register("Design Charge Capacity", SMBusBattDevReg::DESIGN_CAPACITY, EXTERNALFC::I2CRegisters::RegMode::RDONLY);
    add_register("Design Maximum Voltage", SMBusBattDevReg::DESIGN_VOLTAGE, EXTERNALFC::I2CRegisters::RegMode::RDONLY);
    add_register("Specification Info", SMBusBattDevReg::SPECIFICATION_INFO, EXTERNALFC::I2CRegisters::RegMode::RDONLY);
    add_register("Manufacture Date", SMBusBattDevReg::MANUFACTURE_DATE, EXTERNALFC::I2CRegisters::RegMode::RDONLY);
    add_register("Serial", SMBusBattDevReg::SERIAL, EXTERNALFC::I2CRegisters::RegMode::RDONLY);
    add_block("Manufacture Name", SMBusBattDevReg::MANUFACTURE_NAME, EXTERNALFC::I2CRegisters::RegMode::RDONLY);
    add_block("Device Name", SMBusBattDevReg::DEVICE_NAME, EXTERNALFC::I2CRegisters::RegMode::RDONLY);
    add_block("Device Chemistry", SMBusBattDevReg::DEVICE_CHEMISTRY, EXTERNALFC::I2CRegisters::RegMode::RDONLY);
    add_register("Manufacture Data", SMBusBattDevReg::MANUFACTURE_DATA, EXTERNALFC::I2CRegisters::RegMode::RDONLY);
...
void EXTERNALFC::SIM_BattMonitor_SMBus::update(const class Aircraft &aircraft)
{
