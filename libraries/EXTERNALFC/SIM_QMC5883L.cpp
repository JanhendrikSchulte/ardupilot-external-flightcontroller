...
void EXTERNALFC::QMC5883L::reset()
{
...
int EXTERNALFC::QMC5883L::rdwr(I2C::i2c_rdwr_ioctl_data *&data)
{
    if (data->nmsgs == 2) {
...
void EXTERNALFC::QMC5883L::update(const Aircraft &aircraft)
{
