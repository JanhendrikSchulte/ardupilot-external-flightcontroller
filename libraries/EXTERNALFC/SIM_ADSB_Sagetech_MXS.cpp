...
bool ADSB_Sagetech_MXS::handle_message(const EXTERNALFC::ADSB_Sagetech_MXS::Installation& opmsg)
{
...
bool ADSB_Sagetech_MXS::handle_message(const EXTERNALFC::ADSB_Sagetech_MXS::FlightIDMessage& _msg)
{
...
bool ADSB_Sagetech_MXS::handle_message(const EXTERNALFC::ADSB_Sagetech_MXS::Operating& _msg)
{
...
bool ADSB_Sagetech_MXS::handle_message(const EXTERNALFC::ADSB_Sagetech_MXS::GPS& _msg)
{
...
bool ADSB_Sagetech_MXS::handle_message(const EXTERNALFC::ADSB_Sagetech_MXS::DataRequest& _msg)
{
...
bool ADSB_Sagetech_MXS::handle_message(const EXTERNALFC::ADSB_Sagetech_MXS::TargetRequest& _msg)
{
...
void ADSB_Sagetech_MXS::update_serial_output_vehicles(const EXTERNALFC::Aircraft *sitl_model)
{
...
void ADSB_Sagetech_MXS::send_vehicle_message(const EXTERNALFC::ADSB_Vehicle &vehicle)
{
    send_vehicle_message_state_vector(vehicle);
    send_vehicle_message_status_report(vehicle);
}

void ADSB_Sagetech_MXS::send_vehicle_message_state_vector(const EXTERNALFC::ADSB_Vehicle &vehicle)
{
...
void ADSB_Sagetech_MXS::send_vehicle_message_status_report(const EXTERNALFC::ADSB_Vehicle &vehicle)
{
...
void ADSB_Sagetech_MXS::update(const EXTERNALFC::Aircraft *sitl_model)
{
