...
int EXTERNALFC::INA3221::rdwr(I2C::i2c_rdwr_ioctl_data *&data)
{
    if (data->nmsgs == 2) {
...
void EXTERNALFC::INA3221::update(const class Aircraft &aircraft)
{
