...
EXTERNALFC::Rotoye::Rotoye() :
    SIM_BattMonitor_SMBus_Generic()
{
    add_register("External Temperature", SMBusBattRotoyeDevReg::TEMP_EXT, EXTERNALFC::I2CRegisters::RegMode::RDONLY);
...
void EXTERNALFC::Rotoye::update(const class Aircraft &aircraft)
{
