...
private:
    ...
    bool handle_message(const EXTERNALFC::ADSB_Sagetech_MXS::Installation&);
    bool handle_message(const EXTERNALFC::ADSB_Sagetech_MXS::FlightIDMessage&);
    bool handle_message(const EXTERNALFC::ADSB_Sagetech_MXS::Operating&);
    bool handle_message(const EXTERNALFC::ADSB_Sagetech_MXS::GPS&);
    bool handle_message(const EXTERNALFC::ADSB_Sagetech_MXS::DataRequest&);
    bool handle_message(const EXTERNALFC::ADSB_Sagetech_MXS::TargetRequest&);
    // bool handle_message(const EXTERNALFC::ADSB_Sagetech_MXS::StateVectorReport&);
