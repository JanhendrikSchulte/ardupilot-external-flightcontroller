...
#define AP_RCPROTOCOL_UDP_ENABLED AP_RCPROTOCOL_BACKEND_DEFAULT_ENABLED && ((CONFIG_HAL_BOARD == HAL_BOARD_SITL) || (CONFIG_HAL_BOARD == HAL_BOARD_EXTERNALFC))
#endif

#ifndef AP_RCPROTOCOL_FDM_ENABLED
#define AP_RCPROTOCOL_FDM_ENABLED AP_RCPROTOCOL_BACKEND_DEFAULT_ENABLED && ((CONFIG_HAL_BOARD == HAL_BOARD_SITL) || (CONFIG_HAL_BOARD == HAL_BOARD_EXTERNALFC))
#endif